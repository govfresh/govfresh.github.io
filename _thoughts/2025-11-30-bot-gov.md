...
I've started work on [policy](https://github.com/govfresh/gov-bot-governance/blob/main/gov-bot-policy.md) and [implementation checklist](https://github.com/govfresh/gov-bot-governance/blob/main/gov-bot-policy-implementation-checklist.md) templates (with Claude's help) to help governments better implement and share their bot access governance. These templates are available in the [GovFresh bot governance GitHub repository](https://github.com/govfresh/gov-bot-governance/blob/main/README.md). Feel free to submit issues or pull requests.
